...
<form method="post" action="<?php echo base_url();?>index.php/users/update_scores" >
<?php
extract($scores);
?>
...
<td><input type="text" name="sub_id" size="20" value="<?php echo $sub_id; ?>" /></td>
</tr>
<tr>
<th align="right" scope="row">Enter marks</th>
<td><input type="text" name="marks" size="20" value="<?php echo $marks; ?>" /></td>
</tr>
<tr>
