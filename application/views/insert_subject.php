...
<form method="post" action="<?php echo base_url();?>index.php/users/insert_sub">
<table border="0" cellpadding="5" align="center">
<tr>
<th  align="right" scope="row">Enter subject name</th>
<td ><input type="text" name="sub_name" size="20" /></td>
</tr>
<tr>
<th align="right" scope="row">Enter  Max Marks</th>
<td><input type="text" name="max_mrks" size="20" /></td>
</tr>
<tr>
