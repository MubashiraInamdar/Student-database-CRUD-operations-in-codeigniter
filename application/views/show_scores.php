...
window.location="<?php echo base_url();?>index.php/users/"+act+"/"+gotoid1+"/"+gotoid2;
...
<td><?php echo $u_key->marks; ?></td>

<td width="40" align="left" ><a href="#" onClick="show_confirm('edit_scores',<?php echo $u_key->id;?>,<?php echo $u_key->sub_id;?>)">Edit</a></td>

<td width="40" align="left" ><a href="#" onClick="show_confirm('delete_scores',<?php echo $u_key->id;?>,<?php echo $u_key->sub_id;?>)">Delete </a></td>
...
<td colspan="7" align="right"> <a href="<?php echo base_url();?>index.php/users/add_scores">Insert scores</a></td>
